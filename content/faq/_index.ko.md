...
<div class="balloon">
원래의 동영상 해상도에 따라 다르지만 240p/360p/720p 중에서 선택할 수 있습니다. 초기 설정은 360p입니다.<br>동영상 화면 좌측 하단의 톱니바퀴 아이콘에서 YouTube 화질을 변경할 수 있습니다.
</div>
<div class="box"><img src="navi_002.png" alt="navi" class="img-right"></div>
{{% /expand%}}
<br>
...
{{%expand "Q. 빨리 감기/되감기 버튼을 사용하거나 동영상을 재생하면 일시 정지합니다. 이것은 버그인가요?" %}}
<div class="balloon">
